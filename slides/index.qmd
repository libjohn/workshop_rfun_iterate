...
I will post the links in chat once we get started<br>
...
-   Code for today
    ...
    -   launch as a container in RStudio: click the *launch binder* button in the GH readme
...
The best way to learn R it to take simple atomic problems with data that you know, and analyses that are familiar to you, then replicate the analysis in R. But, doing these things with familiar data is not always possible in a big diverse group. I invite you to schedule me for consultations.
