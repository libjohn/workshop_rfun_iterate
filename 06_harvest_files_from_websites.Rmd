...
I wouldn't normally code to delete a directory, however, it's done here to keep the size of the repository as small as possible.  Since the code-chunk is set to `eval=FALSE`, this code chunk will not run unless you run it manually.
